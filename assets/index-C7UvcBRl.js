(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();const u=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function I(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(s=>{s.addEventListener("click",n=>{n.preventDefault();const c=s.getAttribute("data-nav");window.location.hash=c,S()})});const t=document.getElementById("nav-toggle"),i=document.getElementById("mobile-overlay");t.addEventListener("click",()=>{t.classList.toggle("open"),i.classList.toggle("open"),document.body.style.overflow=i.classList.contains("open")?"hidden":""}),C(a)}function S(){const a=document.getElementById("nav-toggle"),e=document.getElementById("mobile-overlay");a&&e&&(a.classList.remove("open"),e.classList.remove("open"),document.body.style.overflow="")}function C(a){let e=!1;window.addEventListener("scroll",()=>{e||(window.requestAnimationFrame(()=>{window.scrollY>50?a.classList.add("scrolled"):a.classList.remove("scrolled"),e=!1}),e=!0)})}function W(){const a=window.location.hash.slice(1)||"";document.querySelectorAll(".navbar-link").forEach(e=>{e.getAttribute("data-nav")===a?e.classList.add("active"):e.classList.remove("active")})}function A(){const a=document.getElementById("site-footer");a.className="footer",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const i=e.getAttribute("data-nav");window.location.hash=i,window.scrollTo({top:0,behavior:"smooth"})})})}let o=[],r=0;function R(a,e=0){o=a,r=e;const t=document.getElementById("lightbox-overlay");t.classList.remove("hidden"),t.innerHTML=`
  ...
  `,requestAnimationFrame(()=>t.classList.add("active")),document.getElementById("lightbox-close").addEventListener("click",h),t.addEventListener("click",i=>{i.target===t&&h()}),document.getElementById("lightbox-prev").addEventListener("click",i=>{i.stopPropagation(),v(-1)}),document.getElementById("lightbox-next").addEventListener("click",i=>{i.stopPropagation(),v(1)}),document.addEventListener("keydown",w),document.body.style.overflow="hidden"}function v(a){r=(r+a+o.length)%o.length;const e=document.querySelector(".lightbox-image"),t=document.querySelector(".lightbox-counter");e.style.opacity="0",setTimeout(()=>{e.src=o[r].src,e.alt=o[r].title||"",t.textContent=`${r+1} / ${o.length}`,e.style.opacity="1"},150)}function w(a){a.key==="Escape"&&h(),a.key==="ArrowLeft"&&v(-1),a.key==="ArrowRight"&&v(1)}function h(){const a=document.getElementById("lightbox-overlay");a.classList.remove("active"),setTimeout(()=>{a.classList.add("hidden"),a.innerHTML=""},300),document.removeEventListener("keydown",w),document.body.style.overflow=""}function $(a){const e=document.getElementById("video-modal");e.classList.remove("hidden"),e.innerHTML=`
  ...
  `,requestAnimationFrame(()=>e.classList.add("active")),document.getElementById("video-close").addEventListener("click",m),e.addEventListener("click",t=>{t.target===e&&m()}),document.addEventListener("keydown",k),document.body.style.overflow="hidden"}function k(a){a.key==="Escape"&&m()}function m(){const a=document.getElementById("video-modal");a.classList.remove("active"),setTimeout(()=>{a.classList.add("hidden"),a.innerHTML=""},300),document.removeEventListener("keydown",k),document.body.style.overflow=""}const d=[{id:1,title:"Indian Rock — Waves 23",youtubeId:"1ZSdr3wMT70",category:"live",date:"November 2023",featured:!0,eventId:"waves-23-indian-rock",bandMembers:["Nishant Verma","Tushar Vikash K","Aryan Raj","Vansh Srivastava","Anjishnu Satpathy","Milind Konwar"]},{id:2,title:"Silence of the Amps — Waves 23",youtubeId:"S8snpxnyAo8",category:"live",date:"November 2023",featured:!1,eventId:"waves-23-silence-amps",bandMembers:["Nishant Verma","Chaitanya Pandey","Aryan Raj","Vansh Srivastava","Tushar Vikash K","Milind Konwar"]},{id:3,title:"Mitwa - World Health Day",youtubeId:"HFSOPSBH6_o",category:"cover",date:"April 2024",featured:!1,bandMembers:["Nishant Verma","Tushar Vikash K","Anjishnu Satpathy"]},{id:4,title:"Saiyaan - World Health Day",youtubeId:"rCRwFbHOalw",category:"cover",date:"April 2024",featured:!1,bandMembers:["Nishant Verma","Tushar Vikash K","Anjishnu Satpathy"]},{id:5,title:"Battle of Bands - TAPMI Atharva'37",youtubeId:"a_520VVl9Ro",category:"live",date:"January 2024",featured:!1,eventId:"jan-24-tapmi-band-battle",bandMembers:["Nishant Verma","Tushar Vikash K","Milind Konwar","Satvik Agrawal","Anjishnu Satpathy","Aryan Raj","Vansh Srivastava","Samarth Madhivanan"]},{id:6,title:"Battle of Bands - Chords & Co. Flagship'24",youtubeId:"GzCzWCLVfaQ",category:"live",date:"January 2024",featured:!1,eventId:"jan-24-chords-band-battle",bandMembers:["Nishant Verma","Tushar Vikash K","Milind Konwar","Satvik Agrawal","Anjishnu Satpathy","Aryan Raj","Vansh Srivastava","Samarth Madhivanan"]}],x=[{id:"all",label:"All"},{id:"live",label:"Live Performances"},{id:"cover",label:"Covers"}];function _(){const a=d.find(e=>e.featured)||d[0]||{title:"New Performance Coming Soon",youtubeId:""};return`
  ...
  `}const M=[],E=[];function L(){const a=E.map(t=>`
  ...
  `}const y=a=>a.split(" ")[0],b=a=>[...a].sort((e,t)=>{const i=l.findIndex(n=>n.name===e||n.name.startsWith(e)),s=l.findIndex(n=>n.name===t||n.name.startsWith(t));return i-s});function j(){const a=d.find(s=>s.featured)||d[0],e=d.filter(s=>s.id!==a.id),t=x.map((s,n)=>`
    ...
    <div class="performance-card reveal" data-category="${s.category}" onclick="window.appAPI.openVideo('${s.youtubeId}')">
      ...
      <div class="performance-info">
        ...
        <div class="performer-tags">
          ${b(s.bandMembers||[]).map(n=>`<span class="performer-tag">${y(n)}</span>`).join("")}
        </div>
        ${s.eventId?`
        ...
        <div class="container">
          ...
          <div class="featured-performance reveal-scale">
            ...
            <div class="featured-video-info">
              ...
              <div class="performer-tags">
                ${b(a.bandMembers||[]).map(s=>`<span class="performer-tag">${y(s)}</span>`).join("")}
              </div>
              ${a.eventId?`
  ...
  `}function q(a){const e=g.find(i=>i.id===a);if(!e)return`
    ...
    `;const t=e.photos&&e.photos.length>0;return window.appAPI.openEventLightbox=i=>{window.appAPI.openEventSpecificLightbox(e.photos,i)},`
    <div class="page-container page-event-detail fade-in">
      ...
      ${e.youtubeId?`
        <section class="event-main-media slide-up" style="animation-delay: 0.2s">
          ...
          <div class="performer-tags">
            ${B(e.bandMembers||[]).map(i=>`<span class="performer-tag">${T(i)}</span>`).join("")}
          </div>
        </section>
      `:""}
  ...
  `}const N=a=>[...a].sort((e,t)=>{const i=l.findIndex(n=>n.name===e||n.name.startsWith(e)),s=l.findIndex(n=>n.name===t||n.name.startsWith(t));return i-s});function G(){const a=g.filter(e=>e.type==="competition");return`
            ...
            <tbody>
              ${a.length>0?a.map((e,t)=>`
                <tr class="result-row" onclick="const details = document.getElementById('details-${t}'); details.style.display = details.style.display === 'table-row' ? 'none' : 'table-row'; this.classList.toggle('active-row');">
                  ...
                  <td>
                    ${e.rank?`<span class="result-badge ${K(e.rank)}">${e.rank}</span>`:'<span class="opacity-50">—</span>'}
                  </td>
                </tr>
                  ...
                  <td colspan="5" class="result-details-cell">
                    <div class="result-details-content">
                      <div class="result-members">
                        ...
                        <span class="opacity-80">${e.bandMembers&&e.bandMembers.length>0?N(e.bandMembers).join(", "):"Lineup not specified"}</span>
                      </div>
  ...
  `}function K(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>R(a,e),openVideo:a=>$(a)};const p={"":_,about:D,journey:L,performances:j,events:P,results:G};function f(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[t,i]=e.split("?");if(t&&!p[t]){window.location.hash="";return}const s=new URLSearchParams(i||"");a.style.opacity="0",setTimeout(()=>{const n=p[t]||p[""];a.innerHTML=n(s),window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",W()},150)}function z(){I(),A(),window.addEventListener("hashchange",f),f()}document.addEventListener("DOMContentLoaded",z);
