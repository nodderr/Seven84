(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const d of n.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function s(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(t){if(t.ep)return;t.ep=!0;const n=s(t);fetch(t.href,n)}})();const m=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function w(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",s=>{s.preventDefault();const r=e.getAttribute("data-nav");window.location.hash=r,window.scrollTo({top:0,behavior:"smooth"})})})}let l=[],i=0;function V(a,e=0){l=a,i=e;const s=document.getElementById("lightbox-overlay");s.classList.remove("hidden"),s.innerHTML=`
  ...
  `,requestAnimationFrame(()=>e.classList.add("active")),document.getElementById("video-close").addEventListener("click",b),e.addEventListener("click",s=>{s.target===e&&b()}),document.addEventListener("keydown",B),document.body.style.overflow="hidden"}function B(a){a.key==="Escape"&&b()}function b(){const a=document.getElementById("video-modal");a.classList.remove("active"),setTimeout(()=>{a.classList.add("hidden"),a.innerHTML=""},300),document.removeEventListener("keydown",B),document.body.style.overflow=""}const c=[{id:1,title:"Indian Rock — Waves 23",youtubeId:"1ZSdr3wMT70",category:"live",date:"November 2023",featured:!0,eventId:"waves-23-indian-rock",bandMembers:["Nishant Verma","Tushar Vikash K","Aryan Raj","Vansh Srivastava","Anjishnu Satpathy","Milind Konwar"]},{id:2,title:"Silence of the Amps — Waves 23",youtubeId:"S8snpxnyAo8",category:"live",date:"November 2023",featured:!1,eventId:"waves-23-silence-amps",bandMembers:["Nishant Verma","Chaitanya Pandey","Aryan Raj","Vansh Srivastava","Tushar Vikash K","Milind Konwar"]},{id:3,title:"Mitwa - World Health Day",youtubeId:"HFSOPSBH6_o",category:"cover",date:"April 2024",featured:!1,bandMembers:["Nishant Verma","Tushar Vikash K","Anjishnu Satpathy"]},{id:4,title:"Saiyaan - World Health Day",youtubeId:"rCRwFbHOalw",category:"cover",date:"April 2024",featured:!1,bandMembers:["Nishant Verma","Tushar Vikash K","Anjishnu Satpathy"]},{id:5,title:"Battle of Bands - TAPMI Atharva'37",youtubeId:"a_520VVl9Ro",category:"live",date:"January 2024",featured:!1,eventId:"jan-24-tapmi-band-battle",bandMembers:["Nishant Verma","Tushar Vikash K","Milind Konwar","Satvik Agrawal","Anjishnu Satpathy","Aryan Raj","Vansh Srivastava","Samarth Madhivanan"]},{id:6,title:"Battle of Bands - Chords & Co. Flagship'24",youtubeId:"GzCzWCLVfaQ",category:"live",date:"January 2024",featured:!1,eventId:"jan-24-chords-band-battle",bandMembers:["Nishant Verma","Tushar Vikash K","Milind Konwar","Satvik Agrawal","Anjishnu Satpathy","Aryan Raj","Vansh Srivastava","Samarth Madhivanan"]},{id:7,title:"Battle of Bands - NITTE Incridea'24",youtubeId:"5v_M2xM4pPM",category:"live",date:"February 2024",featured:!1,eventId:"feb-24-nitte-band-battle",bandMembers:["Nishant Verma","Satvik Agrawal","Anjishnu Satpathy","Adithi Angeerasa","Vansh Srivastava","Aryan Raj","Milind Konwar","Tushar Vikash K"]}],N=[{id:"all",label:"All"},{id:"live",label:"Live Performances"},{id:"cover",label:"Covers"}];function A(){const a=c.find(e=>e.featured)||c[0]||{title:"New Performance Coming Soon",youtubeId:""};return`
      ...
      <section class="section section-darker">
        ...
        <div class="highlight-reel">
          ...
          <div class="highlight-scroll" id="performance-highlights-scroll">
            ${c.slice(0,6).map(e=>`
              <div class="highlight-card" onclick="window.appAPI.openVideo('${e.youtubeId}')">
                <img src="https://img.youtube.com/vi/${e.youtubeId}/maxresdefault.jpg" alt="${e.title}" loading="lazy" />
  ...
  `}const y=a=>a.split(" ")[0],u=a=>[...a].sort((e,s)=>{const r=o.findIndex(n=>n.name===e||n.name.startsWith(e)),t=o.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function R(){const a=c.find(t=>t.featured)||c[0],e=c.filter(t=>t.id!==a.id),s=N.map((t,n)=>`
    ...
    <div class="page-container page-events fade-in">
      ...
      <section class="events-catalog slide-up" style="animation-delay: 0.2s">
        ...
        <div class="events-grid">
          ${h.filter(e=>e.youtubeId||e.thumbnail||e.photos&&e.photos.length>0).map(e=>`
  ...
  `}function F(a){const e=h.find(r=>r.id===a);if(!e)return`
    ...
    <div class="page-container page-event-detail fade-in">
      ...
      ${e.youtubeId?`
        <section class="event-main-media slide-up" style="animation-delay: 0.2s">
          ...
          <div class="performer-tags">
            ${L(e.bandMembers||[]).map(r=>`<span class="performer-tag">${D(r)}</span>`).join("")}
          </div>
        </section>
      `:""}
  ...
  `}const q=a=>[...a].sort((e,s)=>{const r=o.findIndex(n=>n.name===e||n.name.startsWith(e)),t=o.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function K(){const a=h.filter(e=>e.type==="competition");return`
  ...
  `}function H(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>V(a,e),openVideo:a=>S(a),scrollHighlights:a=>{const e=document.getElementById("performance-highlights-scroll");if(e){const s=e.clientWidth*.8;e.scrollBy({left:a*s,behavior:"smooth"})}}};const p={"":A,about:C,journey:x,performances:R,events:j,results:K};function f(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[s,r]=e.split("?");if(s&&!p[s]){window.location.hash="";return}const t=new URLSearchParams(r||"");a.style.opacity="0",setTimeout(()=>{const n=p[s]||p[""];a.innerHTML=n(t),window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",E()},150)}function G(){w(),k(),window.addEventListener("hashchange",f),f()}document.addEventListener("DOMContentLoaded",G);
