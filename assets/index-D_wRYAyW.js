(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))l(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&l(r)}).observe(document,{childList:!0,subtree:!0});function s(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function l(t){if(t.ep)return;t.ep=!0;const n=s(t);fetch(t.href,n)}})();const y=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function w(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",s=>{s.preventDefault();const l=e.getAttribute("data-nav");window.location.hash=l,window.scrollTo({top:0,behavior:"smooth"})})})}let i=[],o=0;function V(a,e=0){i=a,o=e;const s=document.getElementById("lightbox-overlay");s.classList.remove("hidden"),s.innerHTML=`
      ...
      <section class="section section-darker">
        ...
        <div class="highlight-reel">
          ...
          <div class="highlight-scroll" id="infinite-reel-scroll">
            ${(()=>{const e=d.slice(0,10),s=e.slice(-3),l=e.slice(0,3),t=[...s,...e,...l];return t.map((n,r)=>`
                <div class="highlight-card ${r<3||r>=t.length-3?"is-clone":""}" 
                     data-index="${r}"
  ...
  `).join(""),e=W.map((s,l)=>`
      <div class="timeline-item">
        ...
        <div class="timeline-content ${l%2!==0?"reveal-left":"reveal-right"}">
  ...
  `}function F(a){const e=b.find(l=>l.id===a);if(!e)return`
    ...
    `;const s=e.photos&&e.photos.length>0;return window.appAPI.openEventLightbox=l=>{window.appAPI.openEventSpecificLightbox(e.photos,l)},`
    <div class="page-container page-event-detail fade-in">
      ...
      ${e.youtubeId?`
        <section class="event-main-media slide-up" style="animation-delay: 0.2s">
          ...
          <div class="performer-tags">
            ${L(e.bandMembers||[]).map(l=>`<span class="performer-tag">${D(l)}</span>`).join("")}
          </div>
        </section>
      `:""}
          ...
          <div class="gallery-masonry" style="--columns: 3;">
            ${e.photos.map((l,t)=>`
              <div class="gallery-item" onclick="appAPI.openEventLightbox(${t})">
                <img src="${l.src}" alt="Event Photo" loading="lazy" />
              </div>
            `).join("")}
          </div>
  ...
  `}const q=a=>[...a].sort((e,s)=>{const l=c.findIndex(n=>n.name===e||n.name.startsWith(e)),t=c.findIndex(n=>n.name===s||n.name.startsWith(s));return l-t});function K(){const a=b.filter(e=>e.type==="competition");return`
