(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function s(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(t){if(t.ep)return;t.ep=!0;const n=s(t);fetch(t.href,n)}})();const m=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function k(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `}const f=a=>{if(a.eventId){const e=v.find(s=>s.id===a.eventId);if(e&&e.thumbnail)return e.thumbnail}return`https://img.youtube.com/vi/${a.youtubeId}/hqdefault.jpg`},I=a=>a.split(" ")[0],B=a=>[...a].sort((e,s)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),t=c.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function D(){const a=d.find(t=>t.featured)||d[0],e=d.filter(t=>t.id!==a.id),s=C.map((t,n)=>`
    ...
    <div class="performance-card reveal" data-category="${t.category}" onclick="window.appAPI.openVideo('${t.youtubeId}')">
      ...
      <div class="performance-info">
        ...
        <div class="performer-tags">
          ${B(t.bandMembers||[]).map(n=>`<span class="performer-tag">${I(n)}</span>`).join("")}
        </div>
        ${t.eventId?`
        ...
        <div class="container">
          ...
          <div class="featured-performance reveal-scale">
            ...
            <div class="featured-video-info">
              ...
              <div class="performer-tags">
                ${B(a.bandMembers||[]).map(t=>`<span class="performer-tag">${I(t)}</span>`).join("")}
              </div>
              ${a.eventId?`
  ...
  `}function L(){const a=document.querySelectorAll(".filter-tab"),e=document.querySelectorAll(".performance-card");a.forEach(s=>{s.addEventListener("click",()=>{a.forEach(t=>t.classList.remove("active")),s.classList.add("active");const r=s.getAttribute("data-filter");e.forEach(t=>{r==="all"||t.getAttribute("data-category")===r?(t.style.display="block",setTimeout(()=>{t.style.opacity="1",t.style.transform="translateY(0)"},50)):(t.style.opacity="0",t.style.transform="translateY(10px)",setTimeout(()=>{t.style.display="none"},300))})})})}const j=a=>a.split(" ")[0],P=a=>[...a].sort((e,s)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),t=c.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function K(a){const e=a?a.get("id"):null;return e?q(e):F()}function F(){return`
  ...
  `}const H=a=>[...a].sort((e,s)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),t=c.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function z(){const a=v.filter(e=>e.type==="competition");return`
  ...
  `}function G(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>N(a,e),openVideo:a=>A(a),scrollHighlights:a=>{const e=document.getElementById("infinite-reel-scroll");if(e){const s=e.clientWidth*.8;e.scrollBy({left:a*s,behavior:"smooth"})}},initInfiniteScroll:()=>{const a=document.getElementById("infinite-reel-scroll");if(!a)return;const e=a.querySelectorAll(".highlight-card");if(e.length===0)return;const s=e[0].offsetWidth+parseInt(getComputedStyle(a).gap),r=e.length-8;a.scrollLeft=s*4,a.addEventListener("scroll",()=>{const t=a.scrollLeft;t>=s*(r+6)?a.scrollTo({left:s*6,behavior:"instant"}):t<=s*2&&a.scrollTo({left:s*(r+2),behavior:"instant"})})}};const h={"":W,about:$,journey:_,performances:D,events:K,results:z};function w(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[s,r]=e.split("?");if(s&&!h[s]){window.location.hash="";return}const t=new URLSearchParams(r||"");a.style.opacity="0",setTimeout(()=>{const n=h[s]||h[""];a.innerHTML=n(t),(!s||s==="")&&window.appAPI.initInfiniteScroll(),window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",E()},150)}function O(){k(),S(),window.addEventListener("hashchange",w),w()}document.addEventListener("DOMContentLoaded",O);
