(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function s(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(t){if(t.ep)return;t.ep=!0;const n=s(t);fetch(t.href,n)}})();const m=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function M(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",s=>{s.preventDefault();const r=e.getAttribute("data-nav");window.location.hash=r,window.scrollTo({top:0,behavior:"smooth"})})})}let l=[],o=0;function N(a,e=0){l=a,o=e;const s=document.getElementById("lightbox-overlay");s.classList.remove("hidden"),s.innerHTML=`
  ...
  `,requestAnimationFrame(()=>s.classList.add("active")),document.getElementById("lightbox-close").addEventListener("click",g),s.addEventListener("click",r=>{r.target===s&&g()}),document.getElementById("lightbox-prev").addEventListener("click",r=>{r.stopPropagation(),p(-1)}),document.getElementById("lightbox-next").addEventListener("click",r=>{r.stopPropagation(),p(1)}),document.addEventListener("keydown",w),document.body.style.overflow="hidden"}function p(a){o=(o+a+l.length)%l.length;const e=document.querySelector(".lightbox-image"),s=document.querySelector(".lightbox-counter");e.style.opacity="0",setTimeout(()=>{e.src=l[o].src,e.alt=l[o].title||"",s.textContent=`${o+1} / ${l.length}`,e.style.opacity="1"},150)}function w(a){a.key==="Escape"&&g(),a.key==="ArrowLeft"&&p(-1),a.key==="ArrowRight"&&p(1)}function g(){const a=document.getElementById("lightbox-overlay");a.classList.remove("active"),setTimeout(()=>{a.classList.add("hidden"),a.innerHTML=""},300),document.removeEventListener("keydown",w),document.body.style.overflow=""}function A(a){const e=document.getElementById("video-modal");e.classList.remove("hidden"),e.innerHTML=`
      ...
      <section class="section section-darker">
        ...
        <div class="highlight-reel">
          ...
          <div class="highlight-scroll" id="infinite-reel-scroll">
            ${(()=>{const e=d.slice(0,10),s=e.slice(-3),r=e.slice(0,3),t=[...s,...e,...r];return t.map((n,i)=>`
                <div class="highlight-card ${i<3||i>=t.length-3?"is-clone":""}" 
                     data-index="${i}"
                     onclick="window.appAPI.openVideo('${n.youtubeId}')">
                   <img src="${y(n)}" alt="${n.title}" loading="lazy" />
        ...
        <div class="container" style="text-align: center; max-width: 800px;">
          <div class="reveal-up">
            ...
            <div class="featured-video-wrapper" style="margin: 0 auto var(--space-xl);" onclick="window.appAPI.openVideo('${a.youtubeId}')">
               <img src="${y(a)}" alt="${a.title}" class="featured-video-thumb" />
  ...
  `}const u=a=>{if(a.eventId){const e=v.find(s=>s.id===a.eventId);if(e&&e.thumbnail)return e.thumbnail}return`https://img.youtube.com/vi/${a.youtubeId}/hqdefault.jpg`},f=a=>a.split(" ")[0],I=a=>[...a].sort((e,s)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),t=c.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function D(){const a=d.find(t=>t.featured)||d[0],e=d.filter(t=>t.id!==a.id),s=C.map((t,n)=>`
  ...
  `).join(""),r=e.map(t=>`
    <div class="performance-card reveal" data-category="${t.category}" onclick="window.appAPI.openVideo('${t.youtubeId}')">
      <div class="performance-thumb-wrapper">
        <img src="${u(t)}" alt="${t.title}" class="performance-thumb" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&q=80'" />
      ...
      <div class="performance-info">
        ...
        <div class="performer-tags">
          ${I(t.bandMembers||[]).map(n=>`<span class="performer-tag">${f(n)}</span>`).join("")}
        </div>
        ${t.eventId?`
        ...
        <div class="container">
          ...
          <div class="featured-performance reveal-scale">
            ...
            <div class="featured-video-wrapper" onclick="window.appAPI.openVideo('${a.youtubeId}')">
              ...
              <img src="${u(a)}" alt="${a.title}" class="featured-video-thumb" onerror="this.src='https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=1600&q=80'" />
              <div class="featured-play-btn"></div>
            </div>
            ...
            <div class="featured-video-info">
              ...
              <div class="performer-tags">
                ${I(a.bandMembers||[]).map(t=>`<span class="performer-tag">${f(t)}</span>`).join("")}
              </div>
              ${a.eventId?`
  ...
  `}function j(){const a=document.querySelectorAll(".filter-tab"),e=document.querySelectorAll(".performance-card");a.forEach(s=>{s.addEventListener("click",()=>{a.forEach(t=>t.classList.remove("active")),s.classList.add("active");const r=s.getAttribute("data-filter");e.forEach(t=>{r==="all"||t.getAttribute("data-category")===r?(t.style.display="block",setTimeout(()=>{t.style.opacity="1",t.style.transform="translateY(0)"},50)):(t.style.opacity="0",t.style.transform="translateY(10px)",setTimeout(()=>{t.style.display="none"},300))})})})}const L=a=>a.split(" ")[0],P=a=>[...a].sort((e,s)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),t=c.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function K(a){const e=a?a.get("id"):null;return e?q(e):F()}function F(){return`
    ...
    <div class="page-container page-event-detail fade-in">
      ...
      ${e.youtubeId?`
        <section class="event-main-media slide-up" style="animation-delay: 0.2s">
          ...
          <div class="performer-tags">
            ${P(e.bandMembers||[]).map(r=>`<span class="performer-tag">${L(r)}</span>`).join("")}
          </div>
        </section>
      `:""}
  ...
  `}const H=a=>[...a].sort((e,s)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),t=c.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function G(){const a=v.filter(e=>e.type==="competition");return`
  ...
  `}function z(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>N(a,e),openVideo:a=>A(a),scrollHighlights:a=>{const e=document.getElementById("infinite-reel-scroll");if(e){const s=e.clientWidth*.8;e.scrollBy({left:a*s,behavior:"smooth"})}},initInfiniteScroll:()=>{const a=document.getElementById("infinite-reel-scroll");if(!a)return;const e=a.querySelectorAll(".highlight-card");if(e.length===0)return;const s=e[0].offsetWidth+parseInt(getComputedStyle(a).gap),r=e.length-6;a.scrollLeft=s*3,a.addEventListener("scroll",()=>{const t=a.scrollLeft,n=a.scrollWidth-a.clientWidth;t>=n-5?a.scrollTo({left:s*3,behavior:"instant"}):t<=5&&a.scrollTo({left:s*r,behavior:"instant"})})}};const h={"":W,about:$,journey:_,performances:D,events:K,results:G};function B(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[s,r]=e.split("?");if(s&&!h[s]){window.location.hash="";return}const t=new URLSearchParams(r||"");a.style.opacity="0",setTimeout(()=>{const n=h[s]||h[""];a.innerHTML=n(t),(!s||s==="")&&window.appAPI.initInfiniteScroll(),window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",V()},150)}function O(){M(),S(),window.addEventListener("hashchange",B),B()}document.addEventListener("DOMContentLoaded",O);
