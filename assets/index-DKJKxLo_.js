(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();const y=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function w(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const r=e.getAttribute("data-nav");window.location.hash=r,window.scrollTo({top:0,behavior:"smooth"})})})}let l=[],i=0;function V(a,e=0){l=a,i=e;const t=document.getElementById("lightbox-overlay");t.classList.remove("hidden"),t.innerHTML=`
  ...
  `}const W=[],R=[];function $(){const a=R.map(t=>`
  ...
  `}const m=a=>a.split(" ")[0],u=a=>[...a].sort((e,t)=>{const r=o.findIndex(n=>n.name===e||n.name.startsWith(e)),s=o.findIndex(n=>n.name===t||n.name.startsWith(t));return r-s});function x(){const a=d.find(s=>s.featured)||d[0],e=d.filter(s=>s.id!==a.id),t=N.map((s,n)=>`
    ...
    <div class="performance-card reveal" data-category="${s.category}" onclick="window.appAPI.openVideo('${s.youtubeId}')">
      ...
      <div class="performance-info">
        ...
        <div class="performer-tags">
          ${u(s.bandMembers||[]).map(n=>`<span class="performer-tag">${m(n)}</span>`).join("")}
        </div>
        ${s.eventId?`
        ...
        <div class="container">
          ...
          <div class="featured-performance reveal-scale">
            ...
            <div class="featured-video-info">
              ...
              <div class="performer-tags">
                ${u(a.bandMembers||[]).map(s=>`<span class="performer-tag">${m(s)}</span>`).join("")}
              </div>
              ${a.eventId?`
  ...
  `}const q=a=>[...a].sort((e,t)=>{const r=o.findIndex(n=>n.name===e||n.name.startsWith(e)),s=o.findIndex(n=>n.name===t||n.name.startsWith(t));return r-s});function K(){const a=b.filter(e=>e.type==="competition");return`
  ...
  `}function G(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>V(a,e),openVideo:a=>S(a)};const p={"":C,about:A,journey:$,performances:x,events:j,results:K};function f(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[t,r]=e.split("?");if(t&&!p[t]){window.location.hash="";return}const s=new URLSearchParams(r||"");a.style.opacity="0",setTimeout(()=>{const n=p[t]||p[""];a.innerHTML=n(s),window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",E()},150)}function z(){w(),k(),window.addEventListener("hashchange",f),f()}document.addEventListener("DOMContentLoaded",z);
