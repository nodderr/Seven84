(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();const u=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function k(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `}const D=[],E=[];function L(){const a=E.map(t=>`
  ...
  `}const b=a=>a.split(" ")[0],y=a=>[...a].sort((e,t)=>{const i=l.findIndex(n=>n.name===e||n.name.startsWith(e)),s=l.findIndex(n=>n.name===t||n.name.startsWith(t));return i-s});function T(){const a=d.find(s=>s.featured)||d[0],e=d.filter(s=>s.id!==a.id),t=x.map((s,n)=>`
    ...
    <div class="page-container page-event-detail fade-in">
      ...
      ${e.youtubeId?`
        <section class="event-main-media slide-up" style="animation-delay: 0.2s">
          ...
          <div class="performer-tags">
            ${B(e.bandMembers||[]).map(i=>`<span class="performer-tag">${j(i)}</span>`).join("")}
          </div>
        </section>
      `:""}
  ...
  `}const N=a=>[...a].sort((e,t)=>{const i=l.findIndex(n=>n.name===e||n.name.startsWith(e)),s=l.findIndex(n=>n.name===t||n.name.startsWith(t));return i-s});function K(){const a=g.filter(e=>e.type==="competition");return`
  ...
  `}function G(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>R(a,e),openVideo:a=>$(a)};const p={"":M,about:_,journey:L,performances:T,events:P,results:K};function f(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[t,i]=e.split("?");if(t&&!p[t]){window.location.hash="";return}const s=new URLSearchParams(i||"");a.style.opacity="0",setTimeout(()=>{const n=p[t]||p[""];a.innerHTML=n(s),window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",A()},150)}function z(){k(),W(),window.addEventListener("hashchange",f),f()}document.addEventListener("DOMContentLoaded",z);
