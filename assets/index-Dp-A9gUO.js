(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function s(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(t){if(t.ep)return;t.ep=!0;const n=s(t);fetch(t.href,n)}})();const y=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function S(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `,document.querySelectorAll("[data-nav]").forEach(t=>{t.addEventListener("click",n=>{n.preventDefault();const l=t.getAttribute("data-nav");window.location.hash=l,u()})});const r=document.getElementById("nav-toggle");r.addEventListener("click",()=>{r.classList.toggle("open"),s.classList.toggle("open"),document.body.style.overflow=s.classList.contains("open")?"hidden":""}),window.addEventListener("resize",()=>{window.innerWidth>768&&s.classList.contains("open")&&u()}),M(a)}function u(){const a=document.getElementById("nav-toggle"),e=document.getElementById("mobile-overlay");a&&e&&(a.classList.remove("open"),e.classList.remove("open"),document.body.style.overflow="")}function M(a){let e=!1;window.addEventListener("scroll",()=>{e||(window.requestAnimationFrame(()=>{window.scrollY>50?a.classList.add("scrolled"):a.classList.remove("scrolled"),e=!1}),e=!0)})}function k(){const a=window.location.hash.slice(1)||"";document.querySelectorAll(".navbar-link").forEach(e=>{e.getAttribute("data-nav")===a?e.classList.add("active"):e.classList.remove("active")})}function V(){const a=document.getElementById("site-footer");a.className="footer",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",s=>{s.preventDefault();const r=e.getAttribute("data-nav");window.location.hash=r,window.scrollTo({top:0,behavior:"smooth"})})})}let i=[],o=0;function E(a,e=0){i=a,o=e;const s=document.getElementById("lightbox-overlay");s.classList.remove("hidden"),s.innerHTML=`
  ...
  `,requestAnimationFrame(()=>s.classList.add("active")),document.getElementById("lightbox-close").addEventListener("click",g),s.addEventListener("click",r=>{r.target===s&&g()}),document.getElementById("lightbox-prev").addEventListener("click",r=>{r.stopPropagation(),p(-1)}),document.getElementById("lightbox-next").addEventListener("click",r=>{r.stopPropagation(),p(1)}),document.addEventListener("keydown",C),document.body.style.overflow="hidden"}function p(a){o=(o+a+i.length)%i.length;const e=document.querySelector(".lightbox-image"),s=document.querySelector(".lightbox-counter");e.style.opacity="0",setTimeout(()=>{e.src=i[o].src,e.alt=i[o].title||"",s.textContent=`${o+1} / ${i.length}`,e.style.opacity="1"},150)}function C(a){a.key==="Escape"&&g(),a.key==="ArrowLeft"&&p(-1),a.key==="ArrowRight"&&p(1)}function g(){const a=document.getElementById("lightbox-overlay");a.classList.remove("active"),setTimeout(()=>{a.classList.add("hidden"),a.innerHTML=""},300),document.removeEventListener("keydown",C),document.body.style.overflow=""}function _(a){const e=document.getElementById("video-modal");e.classList.remove("hidden"),e.innerHTML=`
      ...
      <section class="section section-darker">
        ...
        <div class="highlight-reel">
          ...
          <div class="highlight-scroll" id="infinite-reel-scroll">
            ${(()=>{const e=c.slice(0,10),s=e.slice(-4),r=e.slice(0,4),t=[...s,...e,...r];return t.map((n,l)=>`
                <div class="highlight-card ${l<4||l>=t.length-4?"is-clone":""}" 
                     data-index="${l}"
                     onclick="window.appAPI.openVideo('${n.youtubeId}')">
                   <img src="${m(n)}" alt="${n.title}" loading="lazy" />
  ...
  `}const R=[{date:"August 2023",title:"Beginning the Journey",description:"The first sparks of Seven.84. A group of musicians from different backgrounds coming together in a college dorm room to create a new sound — a fusion of Hindustani classical depth and Bollywood energy.",image:null}],F=[{number:"15",suffix:"+",label:"Live Shows"},{number:"5",suffix:"",label:"Awards Won"},{number:"8",suffix:"",label:"Band Members"},{number:"50",suffix:"k+",label:"Digital Reach"}];function $(){const a=F.map(s=>`
  ...
  `}const f=a=>{if(a.eventId){const e=v.find(s=>s.id===a.eventId);if(e&&e.thumbnail)return e.thumbnail}return`https://img.youtube.com/vi/${a.youtubeId}/hqdefault.jpg`},w=a=>a.split(" ")[0],B=a=>[...a].sort((e,s)=>{const r=d.findIndex(n=>n.name===e||n.name.startsWith(e)),t=d.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function x(){const a=c.find(t=>t.featured)||c[0],e=c.filter(t=>t.id!==a.id),s=N.map((t,n)=>`
    ...
    <div class="performance-card reveal" data-category="${t.category}" onclick="window.appAPI.openVideo('${t.youtubeId}')">
      ...
      <div class="performance-info">
        ...
        <div class="performer-tags">
          ${B(t.bandMembers||[]).map(n=>`<span class="performer-tag">${w(n)}</span>`).join("")}
        </div>
        ${t.eventId?`
        ...
        <div class="container">
          ...
          <div class="featured-performance reveal-scale">
            ...
            <div class="featured-video-info">
              ...
              <div class="performer-tags">
                ${B(a.bandMembers||[]).map(t=>`<span class="performer-tag">${w(t)}</span>`).join("")}
              </div>
              ${a.eventId?`
  ...
  `}function W(){const a=document.querySelectorAll(".filter-tab"),e=document.querySelectorAll(".performance-card");a.forEach(s=>{s.addEventListener("click",()=>{a.forEach(t=>t.classList.remove("active")),s.classList.add("active");const r=s.getAttribute("data-filter");e.forEach(t=>{r==="all"||t.getAttribute("data-category")===r?(t.style.display="block",setTimeout(()=>{t.style.opacity="1",t.style.transform="translateY(0)"},50)):(t.style.opacity="0",t.style.transform="translateY(10px)",setTimeout(()=>{t.style.display="none"},300))})})})}const L=a=>a.split(" ")[0],j=a=>[...a].sort((e,s)=>{const r=d.findIndex(n=>n.name===e||n.name.startsWith(e)),t=d.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function P(a){const e=a?a.get("id"):null;return e?G(e):K()}function K(){return`
  ...
  `}function G(a){const e=v.find(r=>r.id===a);if(!e)return`
    ...
    <div class="page-container page-event-detail fade-in">
      ...
      ${e.youtubeId?`
        <section class="event-main-media slide-up" style="animation-delay: 0.2s">
          ...
          <div class="performer-tags">
            ${j(e.bandMembers||[]).map(r=>`<span class="performer-tag">${L(r)}</span>`).join("")}
          </div>
        </section>
      `:""}
  ...
  `}const q=a=>[...a].sort((e,s)=>{const r=d.findIndex(n=>n.name===e||n.name.startsWith(e)),t=d.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function H(){const a=v.filter(e=>e.type==="competition");return`
  ...
  `}function O(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>E(a,e),openVideo:a=>_(a),scrollHighlights:a=>{const e=document.getElementById("infinite-reel-scroll");if(e){const s=e.clientWidth*.8;e.scrollBy({left:a*s,behavior:"smooth"})}},initInfiniteScroll:()=>{const a=document.getElementById("infinite-reel-scroll");if(!a)return;const e=a.querySelectorAll(".highlight-card");if(e.length===0)return;const s=e[0].offsetWidth+parseInt(getComputedStyle(a).gap),r=e.length-8;a.scrollLeft=s*4,a.addEventListener("scroll",()=>{const t=a.scrollLeft;t>=s*(r+6)?a.scrollTo({left:s*6,behavior:"instant"}):t<=s*2&&a.scrollTo({left:s*(r+2),behavior:"instant"})})}};const h={"":A,about:D,journey:$,performances:x,events:P,results:H};function I(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[s,r]=e.split("?");if(s&&!h[s]){window.location.hash="";return}const t=new URLSearchParams(r||"");a.style.opacity="0",setTimeout(()=>{const n=h[s]||h[""];a.innerHTML=n(t),(!s||s==="")&&window.appAPI.initInfiniteScroll();const l={"":"Seven.84 — Hindustani Bollywood Fusion",about:"Seven.84 — About Us",journey:"Seven.84 — Our Journey",performances:"Seven.84 — Performances",events:"Seven.84 — Events & Diary",results:"Seven.84 — Competitions & Results"};document.title=l[s]||l[""],window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",k()},150)}function z(){S(),V(),window.addEventListener("hashchange",I),I()}document.addEventListener("DOMContentLoaded",z);
