(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();const g=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function I(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(s=>{s.addEventListener("click",n=>{n.preventDefault();const c=s.getAttribute("data-nav");window.location.hash=c,S()})});const t=document.getElementById("nav-toggle"),i=document.getElementById("mobile-overlay");t.addEventListener("click",()=>{t.classList.toggle("open"),i.classList.toggle("open"),document.body.style.overflow=i.classList.contains("open")?"hidden":""}),W(a)}function S(){const a=document.getElementById("nav-toggle"),e=document.getElementById("mobile-overlay");a&&e&&(a.classList.remove("open"),e.classList.remove("open"),document.body.style.overflow="")}function W(a){let e=!1;window.addEventListener("scroll",()=>{e||(window.requestAnimationFrame(()=>{window.scrollY>50?a.classList.add("scrolled"):a.classList.remove("scrolled"),e=!1}),e=!0)})}function R(){const a=window.location.hash.slice(1)||"";document.querySelectorAll(".navbar-link").forEach(e=>{e.getAttribute("data-nav")===a?e.classList.add("active"):e.classList.remove("active")})}function $(){const a=document.getElementById("site-footer");a.className="footer",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const i=e.getAttribute("data-nav");window.location.hash=i,window.scrollTo({top:0,behavior:"smooth"})})})}let o=[],r=0;function C(a,e=0){o=a,r=e;const t=document.getElementById("lightbox-overlay");t.classList.remove("hidden"),t.innerHTML=`
  ...
  `}const b=a=>a.split(" ")[0],y=a=>[...a].sort((e,t)=>{const i=l.findIndex(n=>n.name===e||n.name.startsWith(e)),s=l.findIndex(n=>n.name===t||n.name.startsWith(t));return i-s});function V(){const a=d.find(s=>s.featured)||d[0],e=d.filter(s=>s.id!==a.id),t=A.map((s,n)=>`
  ...
  `}function N(a){const e=u.find(i=>i.id===a);if(!e)return`
    ...
    <div class="page-container page-event-detail fade-in">
      ...
      ${e.youtubeId?`
        <section class="event-main-media slide-up" style="animation-delay: 0.2s">
          ...
          <div class="performer-tags">
            ${P(e.bandMembers||[]).map(i=>`<span class="performer-tag">${B(i)}</span>`).join("")}
          </div>
        </section>
      `:""}
  ...
  `}const F=a=>[...a].sort((e,t)=>{const i=l.findIndex(n=>n.name===e||n.name.startsWith(e)),s=l.findIndex(n=>n.name===t||n.name.startsWith(t));return i-s});function G(){const a=u.filter(e=>e.type==="competition");return`
  ...
  `}function K(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>C(a,e),openVideo:a=>x(a)};const p={"":_,about:D,journey:L,performances:V,events:j,results:G};function f(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[t,i]=e.split("?");if(t&&!p[t]){window.location.hash="";return}const s=new URLSearchParams(i||"");a.style.opacity="0",setTimeout(()=>{const n=p[t]||p[""];a.innerHTML=n(s),window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",R()},150)}function z(){I(),$(),window.addEventListener("hashchange",f),f()}document.addEventListener("DOMContentLoaded",z);
