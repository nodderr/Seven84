(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();const y=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function E(){const a=document.getElementById("navbar");let e=window.location.pathname;e.startsWith("/")&&(e=e.slice(1)),e.endsWith("/")&&(e=e.slice(0,-1)),a.className="navbar",a.innerHTML=`
  ...
  `,document.querySelectorAll("[data-nav]").forEach(n=>{n.addEventListener("click",r=>{r.preventDefault();const l=n.getAttribute("data-nav");window.appAPI.navigate(l),u()})});const s=document.getElementById("nav-toggle");s.addEventListener("click",()=>{s.classList.toggle("open"),t.classList.toggle("open"),document.body.style.overflow=t.classList.contains("open")?"hidden":""}),window.addEventListener("resize",()=>{window.innerWidth>768&&t.classList.contains("open")&&u()}),N(a)}function u(){const a=document.getElementById("nav-toggle"),e=document.getElementById("mobile-overlay");a&&e&&(a.classList.remove("open"),e.classList.remove("open"),document.body.style.overflow="")}function N(a){let e=!1;window.addEventListener("scroll",()=>{e||(window.requestAnimationFrame(()=>{window.scrollY>50?a.classList.add("scrolled"):a.classList.remove("scrolled"),e=!1}),e=!0)})}function _(){let a=window.location.pathname;a.startsWith("/")&&(a=a.slice(1)),a.endsWith("/")&&(a=a.slice(0,-1)),document.querySelectorAll(".navbar-link").forEach(e=>{e.getAttribute("data-nav")===a?e.classList.add("active"):e.classList.remove("active")})}function A(){const a=document.getElementById("site-footer");a.className="footer",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const s=e.getAttribute("data-nav");window.appAPI.navigate(s),window.scrollTo({top:0,behavior:"smooth"})})})}let i=[],o=0;function D(a,e=0){i=a,o=e;const t=document.getElementById("lightbox-overlay");t.classList.remove("hidden"),t.innerHTML=`
  ...
  `,requestAnimationFrame(()=>t.classList.add("active")),document.getElementById("lightbox-close").addEventListener("click",g),t.addEventListener("click",s=>{s.target===t&&g()}),document.getElementById("lightbox-prev").addEventListener("click",s=>{s.stopPropagation(),p(-1)}),document.getElementById("lightbox-next").addEventListener("click",s=>{s.stopPropagation(),p(1)}),document.addEventListener("keydown",k),document.body.style.overflow="hidden"}function p(a){o=(o+a+i.length)%i.length;const e=document.querySelector(".lightbox-image"),t=document.querySelector(".lightbox-counter");e.style.opacity="0",setTimeout(()=>{e.src=i[o].src,e.alt=i[o].title||"",t.textContent=`${o+1} / ${i.length}`,e.style.opacity="1"},150)}function k(a){a.key==="Escape"&&g(),a.key==="ArrowLeft"&&p(-1),a.key==="ArrowRight"&&p(1)}function g(){const a=document.getElementById("lightbox-overlay");a.classList.remove("active"),setTimeout(()=>{a.classList.add("hidden"),a.innerHTML=""},300),document.removeEventListener("keydown",k),document.body.style.overflow=""}function R(a){const e=document.getElementById("video-modal");e.classList.remove("hidden"),e.innerHTML=`
          ...
          <div class="highlight-scroll" id="infinite-reel-scroll">
            ${(()=>{const e=c.slice(0,10),t=e.slice(-4),s=e.slice(0,4),n=[...t,...e,...s];return n.map((r,l)=>`
                <div class="highlight-card ${l<4||l>=n.length-4?"is-clone":""}" 
                   ...
                   <img src="${m(r)}" alt="${r.title}" loading="lazy" />
        ...
        <div class="container" style="text-align: center; max-width: 800px;">
          <div class="reveal-up">
            ...
            <div class="featured-video-wrapper" style="margin: 0 auto var(--space-xl);" onclick="window.appAPI.openVideo('${a.youtubeId}')">
               <img src="${m(a)}" alt="${a.title}" class="featured-video-thumb" />
      ...
      <section class="section section-dark">
        <div class="container">
          ...
          <div class="members-roster">
            ${d.map((e,t)=>{const s=e.photo||F(e.name);return`
  ...
  `}const j=[{date:"August 2023",title:"Beginning the Journey",description:"The first sparks of Seven.84. A group of musicians from different backgrounds coming together in a college dorm room to create a new sound — a fusion of Hindustani classical depth and Bollywood energy.",image:null}],L=[{number:"15",suffix:"+",label:"Live Shows"},{number:"5",suffix:"",label:"Awards Won"},{number:"8",suffix:"",label:"Band Members"},{number:"50",suffix:"k+",label:"Digital Reach"}];function P(){const a=L.map(t=>`
  ...
  `}const f=a=>{if(a.eventId){const e=v.find(t=>t.id===a.eventId);if(e&&e.thumbnail)return e.thumbnail}return`https://img.youtube.com/vi/${a.youtubeId}/hqdefault.jpg`},w=a=>a.split(" ")[0],I=a=>[...a].sort((e,t)=>{const s=d.findIndex(r=>r.name===e||r.name.startsWith(e)),n=d.findIndex(r=>r.name===t||r.name.startsWith(t));return s-n});function K(){const a=c.find(n=>n.featured)||c[0],e=c.filter(n=>n.id!==a.id),t=W.map((n,r)=>`
  ...
  `).join(""),s=e.map(n=>`
    <div class="performance-card reveal" data-category="${n.category}" onclick="window.appAPI.openVideo('${n.youtubeId}')">
      <div class="performance-thumb-wrapper">
        <img src="${f(n)}" alt="${n.title}" class="performance-thumb" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&q=80'" />
      ...
      <div class="performance-info">
        ...
        <div class="performer-tags">
          ${I(n.bandMembers||[]).map(r=>`<span class="performer-tag">${w(r)}</span>`).join("")}
        </div>
        ${n.eventId?`
        ...
        <div class="container">
          ...
          <div class="featured-performance reveal-scale">
            ...
            <div class="featured-video-info">
              ...
              <div class="performer-tags">
                ${I(a.bandMembers||[]).map(n=>`<span class="performer-tag">${w(n)}</span>`).join("")}
              </div>
              ${a.eventId?`
  ...
  `}function O(a){const e=v.find(s=>s.id===a);if(!e)return`
    ...
    <div class="page-container page-event-detail fade-in">
      ...
      ${e.youtubeId?`
        <section class="event-main-media slide-up" style="animation-delay: 0.2s">
          ...
          <div class="performer-tags">
            ${T(e.bandMembers||[]).map(s=>`<span class="performer-tag">${B(s)}</span>`).join("")}
          </div>
        </section>
  ...
  `}const C=a=>[...a].sort((e,t)=>{const s=d.findIndex(r=>r.name===e||r.name.startsWith(e)),n=d.findIndex(r=>r.name===t||r.name.startsWith(t));return s-n});function z(){const a=v.filter(s=>s.type==="competition"),e=`
          ...
          <tbody>
            ${a.length>0?a.map((s,n)=>`
              <tr class="result-row" onclick="const details = document.getElementById('details-${n}'); details.style.display = details.style.display === 'table-row' ? 'none' : 'table-row'; this.classList.toggle('active-row');">
                ...
                <td>
                  ${s.rank?`<span class="result-badge ${S(s.rank)}">${s.rank}</span>`:'<span class="opacity-50">—</span>'}
                </td>
              </tr>
                ...
                <td colspan="5" class="result-details-cell">
                  <div class="result-details-content">
                    <div class="result-members">
                      ...
                      <span class="opacity-80">${s.bandMembers&&s.bandMembers.length>0?C(s.bandMembers).join(", "):"Lineup not specified"}</span>
                    </div>
      ...
      ${a.length>0?a.map((s,n)=>`
        <div class="result-card" onclick="const d = this.querySelector('.result-card-details'); d.classList.toggle('open'); this.classList.toggle('active');">
          <div class="result-card-header">
            ...
            ${s.rank?`<span class="result-badge ${S(s.rank)}">${s.rank}</span>`:""}
          </div>
  ...
  `}function S(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>D(a,e),openVideo:a=>R(a),scrollHighlights:a=>{const e=document.getElementById("infinite-reel-scroll");if(e){const t=e.clientWidth*.8;e.scrollBy({left:a*t,behavior:"smooth"})}},navigate:a=>{const e=a.startsWith("/")?a:"/"+a;window.location.pathname+window.location.search!==e&&(history.pushState(null,"",e),window.dispatchEvent(new Event("popstate")))},initInfiniteScroll:()=>{const a=document.getElementById("infinite-reel-scroll");if(!a)return;const e=a.querySelectorAll(".highlight-card");if(e.length===0)return;const t=e[0].offsetWidth+parseInt(getComputedStyle(a).gap),s=e.length-8;a.scrollLeft=t*4,a.addEventListener("scroll",()=>{const n=a.scrollLeft;n>=t*(s+6)?a.scrollTo({left:t*6,behavior:"instant"}):n<=t*2&&a.scrollTo({left:t*(s+2),behavior:"instant"})})}};const h={"":$,about:x,journey:P,performances:K,events:q,results:z};function M(){const a=document.getElementById("page-content");let e=window.location.pathname;e.startsWith("/")&&(e=e.slice(1)),e.endsWith("/")&&(e=e.slice(0,-1)),e&&!h[e]&&(history.replaceState(null,"","/"),e="");const t=window.location.search,s=new URLSearchParams(t||"");a.style.opacity="0",setTimeout(()=>{const n=h[e]||h[""];a.innerHTML=n(s),(!e||e==="")&&window.appAPI.initInfiniteScroll();const r={"":"Seven.84 — Hindustani Bollywood Fusion",about:"Seven.84 — About Us",journey:"Seven.84 — Our Journey",performances:"Seven.84 — Performances",events:"Seven.84 — Events & Diary",results:"Seven.84 — Competitions & Results"};document.title=r[e]||r[""],window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",_()},150)}function U(){E(),A(),window.addEventListener("popstate",M),document.addEventListener("click",a=>{const e=a.target.closest("a");if(e&&!e.target&&e.host===window.location.host){const t=e.getAttribute("href");if(t&&(t.startsWith("/")||t.startsWith("#"))){a.preventDefault();const s=t.startsWith("#")?t.slice(1):t;window.appAPI.navigate(s)}}}),M()}document.addEventListener("DOMContentLoaded",U);
