(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();const y=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function k(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `,document.querySelectorAll("[data-nav]").forEach(s=>{s.addEventListener("click",n=>{n.preventDefault();const l=s.getAttribute("data-nav");window.location.hash=l,m()})});const r=document.getElementById("nav-toggle");r.addEventListener("click",()=>{r.classList.toggle("open"),t.classList.toggle("open"),document.body.style.overflow=t.classList.contains("open")?"hidden":""}),window.addEventListener("resize",()=>{window.innerWidth>768&&t.classList.contains("open")&&m()}),S(a)}function m(){const a=document.getElementById("nav-toggle"),e=document.getElementById("mobile-overlay");a&&e&&(a.classList.remove("open"),e.classList.remove("open"),document.body.style.overflow="")}function S(a){let e=!1;window.addEventListener("scroll",()=>{e||(window.requestAnimationFrame(()=>{window.scrollY>50?a.classList.add("scrolled"):a.classList.remove("scrolled"),e=!1}),e=!0)})}function V(){const a=window.location.hash.slice(1)||"";document.querySelectorAll(".navbar-link").forEach(e=>{e.getAttribute("data-nav")===a?e.classList.add("active"):e.classList.remove("active")})}function E(){const a=document.getElementById("site-footer");a.className="footer",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const r=e.getAttribute("data-nav");window.location.hash=r,window.scrollTo({top:0,behavior:"smooth"})})})}let i=[],o=0;function A(a,e=0){i=a,o=e;const t=document.getElementById("lightbox-overlay");t.classList.remove("hidden"),t.innerHTML=`
  ...
  `,requestAnimationFrame(()=>t.classList.add("active")),document.getElementById("lightbox-close").addEventListener("click",g),t.addEventListener("click",r=>{r.target===t&&g()}),document.getElementById("lightbox-prev").addEventListener("click",r=>{r.stopPropagation(),p(-1)}),document.getElementById("lightbox-next").addEventListener("click",r=>{r.stopPropagation(),p(1)}),document.addEventListener("keydown",T),document.body.style.overflow="hidden"}function p(a){o=(o+a+i.length)%i.length;const e=document.querySelector(".lightbox-image"),t=document.querySelector(".lightbox-counter");e.style.opacity="0",setTimeout(()=>{e.src=i[o].src,e.alt=i[o].title||"",t.textContent=`${o+1} / ${i.length}`,e.style.opacity="1"},150)}function T(a){a.key==="Escape"&&g(),a.key==="ArrowLeft"&&p(-1),a.key==="ArrowRight"&&p(1)}function g(){const a=document.getElementById("lightbox-overlay");a.classList.remove("active"),setTimeout(()=>{a.classList.add("hidden"),a.innerHTML=""},300),document.removeEventListener("keydown",T),document.body.style.overflow=""}function N(a){const e=document.getElementById("video-modal");e.classList.remove("hidden"),e.innerHTML=`
      ...
      <section class="section section-darker">
        ...
        <div class="highlight-reel">
          ...
          <div class="highlight-scroll" id="infinite-reel-scroll">
            ${(()=>{const e=d.slice(0,10),t=e.slice(-4),r=e.slice(0,4),s=[...t,...e,...r];return s.map((n,l)=>`
                <div class="highlight-card ${l<4||l>=s.length-4?"is-clone":""}" 
                     data-index="${l}"
  ...
  `}const f=a=>{if(a.eventId){const e=v.find(t=>t.id===a.eventId);if(e&&e.thumbnail)return e.thumbnail}return`https://img.youtube.com/vi/${a.youtubeId}/hqdefault.jpg`},B=a=>a.split(" ")[0],I=a=>[...a].sort((e,t)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),s=c.findIndex(n=>n.name===t||n.name.startsWith(t));return r-s});function j(){const a=d.find(s=>s.featured)||d[0],e=d.filter(s=>s.id!==a.id),t=C.map((s,n)=>`
    ...
    <div class="performance-card reveal" data-category="${s.category}" onclick="window.appAPI.openVideo('${s.youtubeId}')">
      ...
      <div class="performance-info">
        ...
        <div class="performer-tags">
          ${I(s.bandMembers||[]).map(n=>`<span class="performer-tag">${B(n)}</span>`).join("")}
        </div>
        ${s.eventId?`
        ...
        <div class="container">
          ...
          <div class="featured-performance reveal-scale">
            ...
            <div class="featured-video-info">
              ...
              <div class="performer-tags">
                ${I(a.bandMembers||[]).map(s=>`<span class="performer-tag">${B(s)}</span>`).join("")}
              </div>
              ${a.eventId?`
  ...
  `}function D(){const a=document.querySelectorAll(".filter-tab"),e=document.querySelectorAll(".performance-card");a.forEach(t=>{t.addEventListener("click",()=>{a.forEach(s=>s.classList.remove("active")),t.classList.add("active");const r=t.getAttribute("data-filter");e.forEach(s=>{r==="all"||s.getAttribute("data-category")===r?(s.style.display="block",setTimeout(()=>{s.style.opacity="1",s.style.transform="translateY(0)"},50)):(s.style.opacity="0",s.style.transform="translateY(10px)",setTimeout(()=>{s.style.display="none"},300))})})})}const L=a=>a.split(" ")[0],P=a=>[...a].sort((e,t)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),s=c.findIndex(n=>n.name===t||n.name.startsWith(t));return r-s});function K(a){const e=a?a.get("id"):null;return e?q(e):F()}function F(){return`
  ...
  `}const H=a=>[...a].sort((e,t)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),s=c.findIndex(n=>n.name===t||n.name.startsWith(t));return r-s});function O(){const a=v.filter(e=>e.type==="competition");return`
  ...
  `}function z(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>A(a,e),openVideo:a=>N(a),scrollHighlights:a=>{const e=document.getElementById("infinite-reel-scroll");if(e){const t=e.clientWidth*.8;e.scrollBy({left:a*t,behavior:"smooth"})}},initInfiniteScroll:()=>{const a=document.getElementById("infinite-reel-scroll");if(!a)return;const e=a.querySelectorAll(".highlight-card");if(e.length===0)return;const t=e[0].offsetWidth+parseInt(getComputedStyle(a).gap),r=e.length-8;a.scrollLeft=t*4,a.addEventListener("scroll",()=>{const s=a.scrollLeft;s>=t*(r+6)?a.scrollTo({left:t*6,behavior:"instant"}):s<=t*2&&a.scrollTo({left:t*(r+2),behavior:"instant"})})}};const h={"":R,about:W,journey:_,performances:j,events:K,results:O};function w(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[t,r]=e.split("?");if(t&&!h[t]){window.location.hash="";return}const s=new URLSearchParams(r||"");a.style.opacity="0",setTimeout(()=>{const n=h[t]||h[""];a.innerHTML=n(s),(!t||t==="")&&window.appAPI.initInfiniteScroll(),window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",V()},150)}function G(){k(),E(),window.addEventListener("hashchange",w),w()}document.addEventListener("DOMContentLoaded",G);
