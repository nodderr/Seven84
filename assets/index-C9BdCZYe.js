(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function s(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(t){if(t.ep)return;t.ep=!0;const r=s(t);fetch(t.href,r)}})();const y=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function V(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `,document.querySelectorAll("[data-nav]").forEach(t=>{t.addEventListener("click",r=>{r.preventDefault();const l=t.getAttribute("data-nav");window.location.hash=l,u()})});const n=document.getElementById("nav-toggle");n.addEventListener("click",()=>{n.classList.toggle("open"),s.classList.toggle("open"),document.body.style.overflow=s.classList.contains("open")?"hidden":""}),window.addEventListener("resize",()=>{window.innerWidth>768&&s.classList.contains("open")&&u()}),k(a)}function u(){const a=document.getElementById("nav-toggle"),e=document.getElementById("mobile-overlay");a&&e&&(a.classList.remove("open"),e.classList.remove("open"),document.body.style.overflow="")}function k(a){let e=!1;window.addEventListener("scroll",()=>{e||(window.requestAnimationFrame(()=>{window.scrollY>50?a.classList.add("scrolled"):a.classList.remove("scrolled"),e=!1}),e=!0)})}function E(){const a=window.location.hash.slice(1)||"";document.querySelectorAll(".navbar-link").forEach(e=>{e.getAttribute("data-nav")===a?e.classList.add("active"):e.classList.remove("active")})}function N(){const a=document.getElementById("site-footer");a.className="footer",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",s=>{s.preventDefault();const n=e.getAttribute("data-nav");window.location.hash=n,window.scrollTo({top:0,behavior:"smooth"})})})}let i=[],o=0;function _(a,e=0){i=a,o=e;const s=document.getElementById("lightbox-overlay");s.classList.remove("hidden"),s.innerHTML=`
  ...
  `,requestAnimationFrame(()=>s.classList.add("active")),document.getElementById("lightbox-close").addEventListener("click",g),s.addEventListener("click",n=>{n.target===s&&g()}),document.getElementById("lightbox-prev").addEventListener("click",n=>{n.stopPropagation(),p(-1)}),document.getElementById("lightbox-next").addEventListener("click",n=>{n.stopPropagation(),p(1)}),document.addEventListener("keydown",S),document.body.style.overflow="hidden"}function p(a){o=(o+a+i.length)%i.length;const e=document.querySelector(".lightbox-image"),s=document.querySelector(".lightbox-counter");e.style.opacity="0",setTimeout(()=>{e.src=i[o].src,e.alt=i[o].title||"",s.textContent=`${o+1} / ${i.length}`,e.style.opacity="1"},150)}function S(a){a.key==="Escape"&&g(),a.key==="ArrowLeft"&&p(-1),a.key==="ArrowRight"&&p(1)}function g(){const a=document.getElementById("lightbox-overlay");a.classList.remove("active"),setTimeout(()=>{a.classList.add("hidden"),a.innerHTML=""},300),document.removeEventListener("keydown",S),document.body.style.overflow=""}function A(a){const e=document.getElementById("video-modal");e.classList.remove("hidden"),e.innerHTML=`
      ...
      <section class="section section-darker">
        ...
        <div class="highlight-reel">
          ...
          <div class="highlight-scroll" id="infinite-reel-scroll">
            ${(()=>{const e=c.slice(0,10),s=e.slice(-4),n=e.slice(0,4),t=[...s,...e,...n];return t.map((r,l)=>`
                <div class="highlight-card ${l<4||l>=t.length-4?"is-clone":""}" 
                     data-index="${l}"
  ...
  `}const W=[{date:"August 2023",title:"Beginning the Journey",description:"The first sparks of Seven.84. A group of musicians from different backgrounds coming together in a college dorm room to create a new sound — a fusion of Hindustani classical depth and Bollywood energy.",image:null}],$=[{number:"15",suffix:"+",label:"Live Shows"},{number:"5",suffix:"",label:"Awards Won"},{number:"8",suffix:"",label:"Band Members"},{number:"50",suffix:"k+",label:"Digital Reach"}];function x(){const a=$.map(s=>`
  ...
  `}const f=a=>{if(a.eventId){const e=v.find(s=>s.id===a.eventId);if(e&&e.thumbnail)return e.thumbnail}return`https://img.youtube.com/vi/${a.youtubeId}/hqdefault.jpg`},w=a=>a.split(" ")[0],I=a=>[...a].sort((e,s)=>{const n=d.findIndex(r=>r.name===e||r.name.startsWith(e)),t=d.findIndex(r=>r.name===s||r.name.startsWith(s));return n-t});function j(){const a=c.find(t=>t.featured)||c[0],e=c.filter(t=>t.id!==a.id),s=R.map((t,r)=>`
    <button class="filter-tab ${r===0?"active":""}" data-filter="${t.id}">
      ${t.label}
    </button>
  `).join(""),n=e.map(t=>`
    <div class="performance-card reveal" data-category="${t.category}" onclick="window.appAPI.openVideo('${t.youtubeId}')">
      <div class="performance-thumb-wrapper">
        <img src="${f(t)}" alt="${t.title}" class="performance-thumb" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&q=80'" />
      ...
      <div class="performance-info">
        ...
        <div class="performer-tags">
          ${I(t.bandMembers||[]).map(r=>`<span class="performer-tag">${w(r)}</span>`).join("")}
        </div>
        ${t.eventId?`
        ...
        <div class="container">
          ...
          <div class="featured-performance reveal-scale">
            ...
            <div class="featured-video-info">
              ...
              <div class="performer-tags">
                ${I(a.bandMembers||[]).map(t=>`<span class="performer-tag">${w(t)}</span>`).join("")}
              </div>
              ${a.eventId?`
  ...
  `}function L(){const a=document.querySelectorAll(".filter-tab"),e=document.querySelectorAll(".performance-card");a.forEach(s=>{s.addEventListener("click",()=>{a.forEach(t=>t.classList.remove("active")),s.classList.add("active");const n=s.getAttribute("data-filter");e.forEach(t=>{n==="all"||t.getAttribute("data-category")===n?(t.style.display="block",setTimeout(()=>{t.style.opacity="1",t.style.transform="translateY(0)"},50)):(t.style.opacity="0",t.style.transform="translateY(10px)",setTimeout(()=>{t.style.display="none"},300))})})})}const B=a=>a.split(" ")[0],T=a=>[...a].sort((e,s)=>{const n=d.findIndex(r=>r.name===e||r.name.startsWith(e)),t=d.findIndex(r=>r.name===s||r.name.startsWith(s));return n-t});function P(a){const e=a?a.get("id"):null;return e?G(e):K()}function K(){return`
  ...
  `}function G(a){const e=v.find(n=>n.id===a);if(!e)return`
    ...
    `;const s=e.photos&&e.photos.length>0;return window.appAPI.openEventLightbox=n=>{window.appAPI.openEventSpecificLightbox(e.photos,n)},`
        ...
        <section class="event-main-media slide-up" style="animation-delay: 0.2s">
          ${e.youtubeIds.map(n=>`
            <div class="video-embed-container mb-xl">
              <iframe 
                src="https://www.youtube.com/embed/${n}?rel=0&vq=hd1080&modestbranding=1" 
                title="YouTube video player" 
                frameborder="0" 
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                allowfullscreen>
  ...
  `}const q=a=>[...a].sort((e,s)=>{const n=d.findIndex(r=>r.name===e||r.name.startsWith(e)),t=d.findIndex(r=>r.name===s||r.name.startsWith(s));return n-t});function H(){const a=v.filter(e=>e.type==="competition");return`
            ...
            <tbody>
              ${a.length>0?a.map((e,s)=>`
                <tr class="result-row" onclick="const details = document.getElementById('details-${s}'); details.style.display = details.style.display === 'table-row' ? 'none' : 'table-row'; this.classList.toggle('active-row');">
                  ...
                  <td>
                    ${e.rank?`<span class="result-badge ${O(e.rank)}">${e.rank}</span>`:'<span class="opacity-50">—</span>'}
                  </td>
                </tr>
                  ...
                  <td colspan="5" class="result-details-cell">
                    <div class="result-details-content">
                      <div class="result-members">
                        ...
                        <span class="opacity-80">${e.bandMembers&&e.bandMembers.length>0?q(e.bandMembers).join(", "):"Lineup not specified"}</span>
                      </div>
  ...
  `}function O(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>_(a,e),openVideo:a=>A(a),scrollHighlights:a=>{const e=document.getElementById("infinite-reel-scroll");if(e){const s=e.clientWidth*.8;e.scrollBy({left:a*s,behavior:"smooth"})}},initInfiniteScroll:()=>{const a=document.getElementById("infinite-reel-scroll");if(!a)return;const e=a.querySelectorAll(".highlight-card");if(e.length===0)return;const s=e[0].offsetWidth+parseInt(getComputedStyle(a).gap),n=e.length-8;a.scrollLeft=s*4,a.addEventListener("scroll",()=>{const t=a.scrollLeft;t>=s*(n+6)?a.scrollTo({left:s*6,behavior:"instant"}):t<=s*2&&a.scrollTo({left:s*(n+2),behavior:"instant"})})}};const h={"":D,about:F,journey:x,performances:j,events:P,results:H};function C(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[s,n]=e.split("?");if(s&&!h[s]){window.location.hash="";return}const t=new URLSearchParams(n||"");a.style.opacity="0",setTimeout(()=>{const r=h[s]||h[""];a.innerHTML=r(t),(!s||s==="")&&window.appAPI.initInfiniteScroll();const l={"":"Seven.84 — Hindustani Bollywood Fusion",about:"Seven.84 — About Us",journey:"Seven.84 — Our Journey",performances:"Seven.84 — Performances",events:"Seven.84 — Events & Diary",results:"Seven.84 — Competitions & Results"};document.title=l[s]||l[""],window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",E()},150)}function z(){V(),N(),window.addEventListener("hashchange",C),C()}document.addEventListener("DOMContentLoaded",z);
