(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const d of n.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function s(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(t){if(t.ep)return;t.ep=!0;const n=s(t);fetch(t.href,n)}})();const h=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function w(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `}const m=a=>a.split(" ")[0],u=a=>[...a].sort((e,s)=>{const r=o.findIndex(n=>n.name===e||n.name.startsWith(e)),t=o.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function R(){const a=c.find(t=>t.featured)||c[0],e=c.filter(t=>t.id!==a.id),s=N.map((t,n)=>`
    ...
    <div class="page-container page-events fade-in">
      ...
      <section class="events-catalog slide-up" style="animation-delay: 0.2s">
        ...
        <div class="events-grid">
          ${y.filter(e=>e.youtubeId||e.thumbnail||e.photos&&e.photos.length>0).map(e=>`
  ...
  `}function F(a){const e=y.find(r=>r.id===a);if(!e)return`
  ...
  `}const q=a=>[...a].sort((e,s)=>{const r=o.findIndex(n=>n.name===e||n.name.startsWith(e)),t=o.findIndex(n=>n.name===s||n.name.startsWith(s));return r-t});function K(){const a=y.filter(e=>e.type==="competition");return`
  ...
  `}function G(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>V(a,e),openVideo:a=>S(a)};const p={"":A,about:C,journey:x,performances:R,events:j,results:K};function f(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[s,r]=e.split("?");if(s&&!p[s]){window.location.hash="";return}const t=new URLSearchParams(r||"");a.style.opacity="0",setTimeout(()=>{const n=p[s]||p[""];a.innerHTML=n(t),window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",E()},150)}function H(){w(),k(),window.addEventListener("hashchange",f),f()}document.addEventListener("DOMContentLoaded",H);
