(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();const y=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function k(){const a=document.getElementById("navbar"),e=window.location.hash.slice(1)||"";a.className="navbar",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const r=e.getAttribute("data-nav");window.location.hash=r,window.scrollTo({top:0,behavior:"smooth"})})})}let i=[],o=0;function N(a,e=0){i=a,o=e;const t=document.getElementById("lightbox-overlay");t.classList.remove("hidden"),t.innerHTML=`
  ...
  `}const f=a=>{if(a.eventId){const e=v.find(t=>t.id===a.eventId);if(e&&e.thumbnail)return e.thumbnail}return`https://img.youtube.com/vi/${a.youtubeId}/hqdefault.jpg`},I=a=>a.split(" ")[0],B=a=>[...a].sort((e,t)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),s=c.findIndex(n=>n.name===t||n.name.startsWith(t));return r-s});function j(){const a=d.find(s=>s.featured)||d[0],e=d.filter(s=>s.id!==a.id),t=C.map((s,n)=>`
  ...
  `}function D(){const a=document.querySelectorAll(".filter-tab"),e=document.querySelectorAll(".performance-card");a.forEach(t=>{t.addEventListener("click",()=>{a.forEach(s=>s.classList.remove("active")),t.classList.add("active");const r=t.getAttribute("data-filter");e.forEach(s=>{r==="all"||s.getAttribute("data-category")===r?(s.style.display="block",setTimeout(()=>{s.style.opacity="1",s.style.transform="translateY(0)"},50)):(s.style.opacity="0",s.style.transform="translateY(10px)",setTimeout(()=>{s.style.display="none"},300))})})})}const L=a=>a.split(" ")[0],P=a=>[...a].sort((e,t)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),s=c.findIndex(n=>n.name===t||n.name.startsWith(t));return r-s});function F(a){const e=a?a.get("id"):null;return e?G(e):K()}function K(){return`
  ...
  `}const q=a=>[...a].sort((e,t)=>{const r=c.findIndex(n=>n.name===e||n.name.startsWith(e)),s=c.findIndex(n=>n.name===t||n.name.startsWith(t));return r-s});function H(){const a=v.filter(e=>e.type==="competition");return`
  ...
  `}function O(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>N(a,e),openVideo:a=>A(a),scrollHighlights:a=>{const e=document.getElementById("infinite-reel-scroll");if(e){const t=e.clientWidth*.8;e.scrollBy({left:a*t,behavior:"smooth"})}},initInfiniteScroll:()=>{const a=document.getElementById("infinite-reel-scroll");if(!a)return;const e=a.querySelectorAll(".highlight-card");if(e.length===0)return;const t=e[0].offsetWidth+parseInt(getComputedStyle(a).gap),r=e.length-8;a.scrollLeft=t*4,a.addEventListener("scroll",()=>{const s=a.scrollLeft;s>=t*(r+6)?a.scrollTo({left:t*6,behavior:"instant"}):s<=t*2&&a.scrollTo({left:t*(r+2),behavior:"instant"})})}};const h={"":R,about:W,journey:_,performances:j,events:F,results:H};function w(){const a=document.getElementById("page-content"),e=window.location.hash.slice(1),[t,r]=e.split("?");if(t&&!h[t]){window.location.hash="";return}const s=new URLSearchParams(r||"");a.style.opacity="0",setTimeout(()=>{const n=h[t]||h[""];a.innerHTML=n(s),(!t||t==="")&&window.appAPI.initInfiniteScroll(),window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",V()},150)}function z(){k(),E(),window.addEventListener("hashchange",w),w()}document.addEventListener("DOMContentLoaded",z);
