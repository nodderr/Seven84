(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))t(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const m=[{path:"",label:"Home"},{path:"events",label:"Events"},{path:"performances",label:"Performances"},{path:"results",label:"Results"},{path:"journey",label:"Our Journey"},{path:"about",label:"About Us"}];function x(){const a=document.getElementById("navbar");let e=window.location.pathname;e.startsWith("/")&&(e=e.slice(1)),e.endsWith("/")&&(e=e.slice(0,-1)),a.className="navbar",a.innerHTML=`
  ...
  `,a.querySelectorAll("[data-nav]").forEach(e=>{e.addEventListener("click",s=>{s.preventDefault();const t=e.getAttribute("data-nav");window.appAPI.navigate(t),window.scrollTo({top:0,behavior:"smooth"})})})}let i=[],o=0;function K(a,e=0){i=a,o=e;const s=document.getElementById("lightbox-overlay");s.classList.remove("hidden"),s.innerHTML=`
  ...
  `,requestAnimationFrame(()=>s.classList.add("active")),document.getElementById("lightbox-close").addEventListener("click",g),s.addEventListener("click",t=>{t.target===s&&g()}),document.getElementById("lightbox-prev").addEventListener("click",t=>{t.stopPropagation(),v(-1)}),document.getElementById("lightbox-next").addEventListener("click",t=>{t.stopPropagation(),v(1)}),document.addEventListener("keydown",E),document.body.style.overflow="hidden"}function v(a){o=(o+a+i.length)%i.length;const e=document.querySelector(".lightbox-image"),s=document.querySelector(".lightbox-counter");e.style.opacity="0",setTimeout(()=>{e.src=i[o].src,e.alt=i[o].title||"",s.textContent=`${o+1} / ${i.length}`,e.style.opacity="1"},150)}function E(a){a.key==="Escape"&&g(),a.key==="ArrowLeft"&&v(-1),a.key==="ArrowRight"&&v(1)}function g(){const a=document.getElementById("lightbox-overlay");a.classList.remove("active"),setTimeout(()=>{a.classList.add("hidden"),a.innerHTML=""},300),document.removeEventListener("keydown",E),document.body.style.overflow=""}function G(a){const e=document.getElementById("video-modal");e.classList.remove("hidden"),e.innerHTML=`
      ...
      <section class="section section-darker">
        ...
        <div class="highlight-reel">
          ...
          <div class="highlight-scroll" id="infinite-reel-scroll">
            ${(()=>{const e=[...p].reverse().slice(0,10),s=e.slice(-4),t=e.slice(0,4),r=[...s,...e,...t];return r.map((n,l)=>`
                <div class="highlight-card ${l<4||l>=r.length-4?"is-clone":""}" 
                     data-index="${l}"
                     onclick="window.appAPI.openVideo('${n.youtubeId}')">
                   <img src="${w(n)}" alt="${n.title}" loading="lazy" />
  ...
  `}function Y(){const a=document.getElementById("stats-bar");if(!a)return;const e=a.querySelectorAll(".stat-number");let s=!1;const t=()=>{s||(s=!0,e.forEach(n=>{const l=parseInt(n.dataset.count,10),A=n.dataset.suffix||"",_=1500,D=performance.now(),y=R=>{const W=R-D,u=Math.min(W/_,1),$=1-Math.pow(1-u,3),F=Math.round($*l);n.textContent=F+A,u<1&&requestAnimationFrame(y)};requestAnimationFrame(y)}))},r=new IntersectionObserver(n=>{n[0].isIntersecting&&(t(),r.disconnect())},{threshold:.3});r.observe(a)}const I=a=>{if(a.eventId){const e=c.find(s=>s.id===a.eventId);if(e&&e.thumbnail)return e.thumbnail}return`https://img.youtube.com/vi/${a.youtubeId}/hqdefault.jpg`},B=a=>a.split(" ")[0],T=a=>[...a].sort((e,s)=>{const t=d.findIndex(n=>n.name===e||n.name.startsWith(e)),r=d.findIndex(n=>n.name===s||n.name.startsWith(s));return t-r});function Z(){const a=[...p].reverse(),e=a.find(n=>n.featured)||a[0],s=a.filter(n=>n.id!==e.id),t=q.map((n,l)=>`
    ...
    <div class="performance-card reveal" data-category="${n.category}" onclick="window.appAPI.openVideo('${n.youtubeId}')">
      ...
      <div class="performance-info">
        ...
        <div class="performer-tags">
          ${T(n.bandMembers||[]).map(l=>`<span class="performer-tag">${B(l)}</span>`).join("")}
        </div>
        ${n.eventId?`
        ...
        <div class="container">
          ...
          <div class="featured-performance reveal-scale">
            ...
            <div class="featured-video-wrapper" onclick="window.appAPI.openVideo('${e.youtubeId}')">
              ...
              <img src="${I(e)}" alt="${e.title}" class="featured-video-thumb" onerror="this.src='https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=1600&q=80'" />
              <div class="featured-play-btn"></div>
            </div>
            ...
            <div class="featured-video-info">
              ...
              <div class="performer-tags">
                ${T(e.bandMembers||[]).map(n=>`<span class="performer-tag">${B(n)}</span>`).join("")}
              </div>
              ${e.eventId?`
                <button class="btn btn-outline btn-sm mt-md" onclick="event.stopPropagation(); window.appAPI.navigate('/events?id=${e.eventId}')">
  ...
  `}function X(){const a=document.querySelectorAll(".filter-tab"),e=document.querySelectorAll(".performance-card");a.forEach(s=>{s.addEventListener("click",()=>{a.forEach(r=>r.classList.remove("active")),s.classList.add("active");const t=s.getAttribute("data-filter");e.forEach(r=>{t==="all"||r.getAttribute("data-category")===t?(r.style.display="block",setTimeout(()=>{r.style.opacity="1",r.style.transform="translateY(0)"},50)):(r.style.opacity="0",r.style.transform="translateY(10px)",setTimeout(()=>{r.style.display="none"},300))})})})}const C=a=>a.split(" ")[0],S=a=>[...a].sort((e,s)=>{const t=d.findIndex(n=>n.name===e||n.name.startsWith(e)),r=d.findIndex(n=>n.name===s||n.name.startsWith(s));return t-r});function ee(a){const e=a?a.get("id"):null;return e?te(e):ae()}function ae(){return`
    <div class="page-container page-events fade-in">
      ...
      <section class="events-catalog slide-up" style="animation-delay: 0.2s">
        ...
        <div class="events-grid">
          ${c.filter(e=>e.youtubeId||e.youtubeIds&&e.youtubeIds.length>0||e.thumbnail||e.photos&&e.photos.length>0).reverse().map(e=>`
  ...
  `}function te(a){const e=c.find(t=>t.id===a);if(!e)return`
    ...
    <div class="page-container page-event-detail fade-in">
      ...
      ${e.youtubeId?`
        <section class="event-main-media slide-up" style="animation-delay: 0.2s">
          ...
          <div class="performer-tags">
            ${S(e.bandMembers||[]).map(t=>`<span class="performer-tag">${C(t)}</span>`).join("")}
          </div>
        </section>
  ...
  `}const M=a=>[...a].sort((e,s)=>{const t=d.findIndex(n=>n.name===e||n.name.startsWith(e)),r=d.findIndex(n=>n.name===s||n.name.startsWith(s));return t-r});function se(){const a=c.filter(t=>t.type==="competition").reverse(),e=`
        ...
        <table class="results-table">
          ...
          <tbody>
            ${a.length>0?a.map((t,r)=>`
              <tr class="result-row" onclick="const details = document.getElementById('details-${r}'); details.style.display = details.style.display === 'table-row' ? 'none' : 'table-row'; this.classList.toggle('active-row');">
                ...
                <td>
                  ${t.rank?`<span class="result-badge ${V(t.rank)}">${t.rank}</span>`:'<span class="opacity-50">—</span>'}
                </td>
              </tr>
                ...
                <td colspan="5" class="result-details-cell">
                  <div class="result-details-content">
                    <div class="result-members">
                      ...
                      <span class="opacity-80">${t.bandMembers&&t.bandMembers.length>0?M(t.bandMembers).join(", "):"Lineup not specified"}</span>
                    </div>
      ...
      ${a.length>0?a.map((t,r)=>`
        <div class="result-card" onclick="const d = this.querySelector('.result-card-details'); d.classList.toggle('open'); this.classList.toggle('active');">
          <div class="result-card-header">
            ...
            ${t.rank?`<span class="result-badge ${V(t.rank)}">${t.rank}</span>`:""}
          </div>
  ...
  `}function V(a){const e=String(a).toLowerCase();return e.includes("1st")||e.includes("winner")||e==="first"?"badge-gold":e.includes("2nd")||e.includes("runner")?"badge-silver":e.includes("3rd")?"badge-bronze":"badge-neutral"}window.appAPI={openEventSpecificLightbox:(a,e)=>K(a,e),openVideo:a=>G(a),scrollHighlights:a=>{const e=document.getElementById("infinite-reel-scroll");if(e){const s=e.clientWidth*.8;e.scrollBy({left:a*s,behavior:"smooth"})}},navigate:a=>{const e=a.startsWith("/")?a:"/"+a;window.location.pathname+window.location.search!==e&&(history.pushState(null,"",e),window.dispatchEvent(new Event("popstate")))},initInfiniteScroll:()=>{const a=document.getElementById("infinite-reel-scroll");if(!a)return;const e=a.querySelectorAll(".highlight-card");if(e.length===0)return;const s=e[0].offsetWidth+parseInt(getComputedStyle(a).gap),t=e.length-8;a.scrollLeft=s*4,a.addEventListener("scroll",()=>{const r=a.scrollLeft;r>=s*(t+6)?a.scrollTo({left:s*6,behavior:"instant"}):r<=s*2&&a.scrollTo({left:s*(t+2),behavior:"instant"})})}};const h={"":H,about:z,journey:Q,performances:Z,events:ee,results:se};function k(){const a=document.getElementById("page-content");let e=window.location.pathname;e.startsWith("/")&&(e=e.slice(1)),e.endsWith("/")&&(e=e.slice(0,-1)),e&&!h[e]&&(history.replaceState(null,"","/"),e="");const s=window.location.search,t=new URLSearchParams(s||"");a.style.opacity="0",setTimeout(()=>{const r=h[e]||h[""];a.innerHTML=r(t),(!e||e==="")&&window.appAPI.initInfiniteScroll();const n={"":"Seven.84 — Hindustani Bollywood Fusion",about:"Seven.84 — About Us",journey:"Seven.84 — Our Journey",performances:"Seven.84 — Performances",events:"Seven.84 — Events & Diary",results:"Seven.84 — Competitions & Results"};document.title=n[e]||n[""],window.scrollTo({top:0,behavior:"instant"}),a.style.opacity="1",L()},150)}function ne(){x(),P(),window.addEventListener("popstate",k),document.addEventListener("click",a=>{const e=a.target.closest("a");if(e&&!e.target&&e.host===window.location.host){const s=e.getAttribute("href");if(s&&(s.startsWith("/")||s.startsWith("#"))){a.preventDefault();const t=s.startsWith("#")?s.slice(1):s;window.appAPI.navigate(t)}}}),k()}document.addEventListener("DOMContentLoaded",ne);
